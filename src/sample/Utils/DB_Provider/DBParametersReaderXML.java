...
public class DBParametersReaderXML implements IDBParametersReader {
    ...
    public DBConnProp read() throws JAXBException {
        ...
        JAXBContext context = JAXBContext.newInstance(DBConnProp.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        DBConnProp prop = (DBConnProp)unmarshaller.unmarshal(file);
   ...
   /* if(false) {
        ...
        try {
            ...
            log.exception("JAXB Exception save config.xml", e);
        }
    }*/
}
